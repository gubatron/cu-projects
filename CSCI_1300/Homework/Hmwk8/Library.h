...
#include <cmath> // for Library::ssd pow() call.
...
public:
    ...
    int readRatings(string ratingsFile);        // populates users[] with string (name of file to be read); returns total number of users in users[] as int
