...
// PROBLEM 6
bool Library::addUser(string username) { // HELPER FUNCTION THAT COMPARES USERNAMES
/**
...
void Library::getRecommendations(string username) {
    ...
    */
    ...
    for (int i = 0, num_recommendations = 0;
         i < 200 && num_recommendations < 5; i++) // each time one is recommended, one is subtracted
    {
