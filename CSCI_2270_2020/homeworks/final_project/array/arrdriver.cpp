    ...
    while (i < 10000)
    {
        ...
        if (num_read_items == 99)
        {
            ...
            while (search_index < total_inserted_items)
            {
                ...
                int random_search_index = randomTo(99999);

                // ARRAY SEARCH
                testData[random_search_index]; // perform the array search, doesn't do anything with the value in the array
