...
int main(int argc, char *argv[]) {
    ...
    ofstream dataResultsInsertFileA("ht_linear_insert_avg_a.csv");
    ofstream dataResultsSearchFileA("ht_linear_search_avg_a.csv");

    ifstream dataSetFileB("dataSetB.csv");
    ofstream dataResultsInsertFileB("ht_linear_insert_avg_b.csv");
    ofstream dataResultsSearchFileB("ht_linear_search_avg_b.csv");
    ...
    cout << endl << "ht_linear.exe finished." << endl;
    return 0;
}
